...
public class EffectSkill : MainEffect
{
	...
	private void set_New_Effect(int typeKill, Object_Effect_Skill Okill, mVector vec)
	{
		...
		case 114:
		{
			...
			vMax = 14;
			vx = vMax;
			for (int num7 = 0; num7 < vecObjBeKill.size(); num7++)
			{
				Object_Effect_Skill object_Effect_Skill7 = (Object_Effect_Skill)vecObjBeKill.elementAt(num7);
				if (object_Effect_Skill7 != null)
				{
					MainObject mainObject5 = MainObject.get_Object(object_Effect_Skill7.ID, object_Effect_Skill7.tem);
					if (mainObject5 != null)
					{
						Point o = create_Stone_Drop(mainObject5.x, mainObject5.y);
						VecEff.addElement(o);
					}
				}
			}
		...
		case 60:
		{
			...
			for (int num12 = 0; num12 < vecObjBeKill.size(); num12++)
			{
				...
				{
					MainObject mainObject7 = MainObject.get_Object(object_Effect_Skill9.ID, object_Effect_Skill9.tem);
					if (mainObject7 != null)
					{
						Point point10 = new Point();
						point10.x = mainObject7.x;
						point10.y = mainObject7.y + mainObject7.ysai;
		...
		case 64:
		{
			...
			for (int n = 0; n < vecObjBeKill.size(); n++)
			{
				...
				{
					MainObject mainObject4 = MainObject.get_Item_Object(object_Effect_Skill6.ID, object_Effect_Skill6.tem);
					if (mainObject4 != null)
					{
						point5.x = mainObject4.x;
						point5.y = mainObject4.y + mainObject4.ysai;
		...
		case 67:
		{
			...
			if (objBeKillMain != null)
			{
				xdich3 = objBeKillMain.x - x;
				ydich3 = objBeKillMain.y - objBeKillMain.hOne / 2 - y;
			}
			else
			{
				xdich3 = toX - x;
			...
			create_Speed(xdich3, ydich3, null);
			break;
		}
		case 68:
			timeAddNum = 20;
		...
		case 74:
		{
			...
			for (int k = 0; k < vecObjBeKill.size(); k++)
			{
				...
				{
					MainObject mainObject = MainObject.get_Item_Object(object_Effect_Skill3.ID, object_Effect_Skill3.tem);
					if (mainObject != null)
					{
						int xdich2 = mainObject.x - x;
						int ydich2 = mainObject.y - mainObject.hOne / 2 - y;
						Point_Focus p = new Point_Focus();
						p = create_Speed_More(xdich2, ydich2, p, mainObject);
						p.x = x;
						p.y = y;
						int frameAngle = CRes.angle(xdich2, ydich2);
		...
		case 93:
		{
			...
			for (int i = 0; i < vecObjBeKill.size(); i++)
			{
				...
				if (object_Effect_Skill2 != null && MainObject.get_Item_Object(object_Effect_Skill2.ID, object_Effect_Skill2.tem) != null)
				{
					point.x = x;
					point.y = y + ysai;
		...
		case 99:
			...
			for (int l = 0; l < vecObjBeKill.size(); l++)
			{
				...
				{
					MainObject mainObject2 = MainObject.get_Item_Object(object_Effect_Skill4.ID, object_Effect_Skill4.tem);
					if (mainObject2 != null)
					{
						point3.x = mainObject2.x;
						point3.y = mainObject2.y + mainObject2.ysai;
			...
			for (int m = 0; m < vecObjBeKill.size(); m++)
			{
				...
				{
					MainObject mainObject3 = MainObject.get_Item_Object(object_Effect_Skill5.ID, object_Effect_Skill5.tem);
					if (mainObject3 != null)
					{
						point4.x = mainObject3.x;
						point4.y = mainObject3.y + mainObject3.ysai;
			...
			for (int num9 = 0; num9 < vecObjBeKill.size(); num9++)
			{
				...
				MainObject mainObject6 = MainObject.get_Object(object_Effect_Skill8.ID, object_Effect_Skill8.tem);
				if (mainObject6 == null)
				{
					continue;
				}
				Point point8 = create_ICE_Drop(mainObject6.x, mainObject6.y);
		...
		if (!isEff && objKill != null && objKill.typeObject != 1)
		{
			for (int num13 = 0; num13 < vecObjBeKill.size(); num13++)
			{
				...
				MainObject mainObject8 = MainObject.get_Object(object_Effect_Skill10.ID, object_Effect_Skill10.tem);
				if (mainObject8 == null)
				{
					vecObjBeKill.removeElement(object_Effect_Skill10);
					num13--;
				}
				else if (mainObject8.Action != 4)
				{
					mainObject8.hp = object_Effect_Skill10.hpLast;
					if (mainObject8.hp <= 0 && mainObject8 != GameScreen.player)
					{
						mainObject8.resetAction();
						mainObject8.Action = 4;
						mainObject8.timedie = GameCanvas.timeNow;
						GameScreen.addEffectEndKill(11, mainObject8.x, mainObject8.y);
					}
				}
	...
	public override void paint(mGraphics g)
	{
		...
		try
		{
			...
			case 6:
				...
				{
					for (int num28 = 0; num28 < mTamgiac.Length; num28++)
					{
						g.setColor(colorpaint[num28 / 2]);
						g.fillTriangle(x1000 / 1000, y1000 / 1000, mTamgiac[num28][0] / 1000, mTamgiac[num28][1] / 1000, mTamgiac[num28][2] / 1000, mTamgiac[num28][3] / 1000, mGraphics.isFalse);
					}
				}
				break;
			case 29:
			...
			case 107:
			{
				...
				{
					Line line3 = (Line)VecEff.elementAt(num41);
					if (line3 != null)
					{
						int cl6 = 0;
						if (num41 / 2 < colorpaint.Length)
						{
							cl6 = colorpaint[num41 / 2];
						}
			...
			case 111:
			{
				...
				for (int num20 = 1; num20 < VecEff.size(); num20++)
				{
					Point point12 = (Point)VecEff.elementAt(num20 - 1);
					Point point13 = (Point)VecEff.elementAt(num20);
					g.setColor(16514254);
				...
				for (int num21 = 1; num21 < VecSubEff.size(); num21++)
				{
					Point point14 = (Point)VecSubEff.elementAt(num21 - 1);
					Point point15 = (Point)VecSubEff.elementAt(num21);
			...
			case 82:
			{
				...
				if (f % 5 < 2 || f % 5 == 3)
				{
					for (int num68 = 1; num68 < VecEff.size(); num68++)
					{
						Point point48 = (Point)VecEff.elementAt(num68 - 1);
						Point point49 = (Point)VecEff.elementAt(num68);
					...
					for (int num69 = 1; num69 < VecSubEff.size(); num69++)
					{
						Point point50 = (Point)VecSubEff.elementAt(num69 - 1);
						Point point51 = (Point)VecSubEff.elementAt(num69);
			...
			case 114:
			{
				...
				{
					Point point39 = (Point)VecSubEff.elementAt(num54);
					if (point39.f / 2 <= 3)
					{
				...
				{
					Point point40 = (Point)VecEff.elementAt(num55);
					if (f < point40.f)
					{
			...
			case 12:
			{
				...
				int num9 = (VecEff.size() / fRemove + 2) * f;
				if (num9 > VecEff.size())
				{
					num9 = VecEff.size();
				}
				...
				{
					Point point6 = (Point)VecEff.elementAt(num10 - 1);
					Point point7 = (Point)VecEff.elementAt(num10);
					if (f <= fRemove - 1)
					{
				...
				if (f <= fRemove - 2)
				{
					num9 = (VecSubEff.size() / fRemove + 2) * f;
					if (num9 > VecSubEff.size())
					{
						num9 = VecSubEff.size();
					}
					for (int num11 = 1; num11 < num9; num11++)
					{
						Point point8 = (Point)VecSubEff.elementAt(num11 - 1);
						Point point9 = (Point)VecSubEff.elementAt(num11);
			...
			case 115:
			{
				...
				{
					Point point55 = (Point)VecEff.elementAt(num73);
					if (point55.f == 0)
					{
			...
			case 113:
			{
				...
				{
					Point point30 = (Point)VecEff.elementAt(num40);
			...
			case 88:
				...
				if (typeEffect == 31 || typeEffect == 88)
				{
					...
					{
						Point point46 = (Point)VecEff.elementAt(num61);
			...
			case 23:
			{
				...
				{
					Point point33 = (Point)VecEff.elementAt(num47);
			...
			case 25:
			{
				...
				{
					Point point11 = (Point)VecEff.elementAt(num13);
					if (point11 != null)
					{
			...
			case 26:
			{
				...
				{
					Point point53 = (Point)VecEff.elementAt(num71);
					if (point53.f < 7)
					{
			...
			case 27:
			{
				...
				{
					Point point52 = (Point)VecEff.elementAt(num70);
					if (point52.f < 3)
					{
			...
			case 30:
			{
				...
				{
					Point point45 = (Point)VecEff.elementAt(num60);
			...
			case 34:
			{
				...
				{
					Point point32 = (Point)VecEff.elementAt(num46);
					int trans = 0;
					if (point32.vx < 0)
					{
						trans = 2;
			...
			case 40:
			{
				...
				{
					Point point26 = (Point)VecEff.elementAt(num34);
					if (point26 != null)
					{
						int num35 = (point26.x + point26.vx) / 1000;
						int num36 = (point26.y + point26.vy) / 1000;
						if (f / 2 % 2 == 0)
						{
							paint_Bullet(g, fraImgEff, point26.frame, num35, num36, isMore: false);
						}
						else
						{
							paint_Bullet(g, fraImgSub2Eff, point26.frame, num35, num36, isMore: false);
						}
					}
				}
				for (int num37 = 0; num37 < VecSubEff.size(); num37++)
				{
					Point point27 = (Point)VecSubEff.elementAt(num37);
			...
			case 83:
			{
				...
				{
					Point point23 = (Point)VecEff.elementAt(num31);
			...
			case 42:
			{
				...
				if (f < fRemove / 2)
				{
					...
					{
						Point point10 = (Point)VecEff.elementAt(num12);
						int cl2 = 16777215;
						if (point10.frame == 1)
						{
							cl2 = 9468112;
			...
			case 112:
			{
				...
				{
					Point point37 = (Point)VecEff.elementAt(num52);
			...
			case 47:
			{
				...
				{
					Point point34 = (Point)VecEff.elementAt(num48);
			...
			case 49:
			{
				...
				{
					Point point25 = (Point)VecEff.elementAt(num33);
			...
			case 125:
			{
				...
				for (int num15 = 0; num15 < size1; num15++)
				{
					int num16 = 0;
					num16 = ((num15 != size1 - 1) ? 16777215 : 720469);
					mVector9.addElement(new mLine(x + num15 * vX1000, y + num15 * vY1000, x1000 + num15 * vX1000, y1000 + num15 * vY1000, num16));
					mVector9.addElement(new mLine(x - num15 * vX1000, y - num15 * vY1000, x1000 - num15 * vX1000, y1000 - num15 * vY1000, num16));
				}
				break;
			}
			case 126:
			{
				...
				for (int num18 = 0; num18 < size1; num18++)
				{
					int num19 = 0;
					num19 = ((num18 != size1 - 1) ? 16777215 : 15771896);
					mVector11.addElement(new mLine(x + num18 * vX1000, y + num18 * vY1000, x1000 + num18 * vX1000, y1000 + num18 * vY1000, num19));
					mVector11.addElement(new mLine(x - num18 * vX1000, y - num18 * vY1000, x1000 - num18 * vX1000, y1000 - num18 * vY1000, num19));
				}
				break;
			}
			...
			case 105:
			{
				...
				if (f < fRemove)
				{
					...
					if (f > 8)
					{
						...
						{
							int num66 = 0;
							num66 = ((num65 != num64 - 1) ? 16777215 : 720469);
							mVector17.addElement(new mLine(x + num65 * vX1000, y + num65 * vY1000, x1000 + num65 * vX1000, y1000 + num65 * vY1000, num66));
							mVector17.addElement(new mLine(x - num65 * vX1000, y - num65 * vY1000, x1000 - num65 * vX1000, y1000 - num65 * vY1000, num66));
						}
					}
				}
				...
				{
					Point point47 = (Point)VecEff.elementAt(num67);
					if (point47 != null)
					{
			...
			case 51:
			{
				...
				if (f < fRemove)
				{
					...
					if (f > 8)
					{
						...
						{
							int num44 = 0;
							num44 = ((num43 != num42 - 1) ? 16777215 : 16711680);
							mVector16.addElement(new mLine(x + num43 * vX1000, y + num43 * vY1000, x1000 + num43 * vX1000, y1000 + num43 * vY1000, num44));
							mVector16.addElement(new mLine(x - num43 * vX1000, y - num43 * vY1000, x1000 - num43 * vX1000, y1000 - num43 * vY1000, num44));
						}
					}
				}
				...
				{
					Point point31 = (Point)VecEff.elementAt(num45);
					if (point31 != null)
					{
			...
			case 54:
			{
				...
				{
					Point point24 = (Point)VecEff.elementAt(num32);
			...
			case 104:
			{
				...
				{
					Point point18 = (Point)VecEff.elementAt(num25);
					if (f <= fRemove)
					{
						int num26 = 0;
						int num27 = 3;
						...
						g.drawRegion(fraImgEff.imgFrame, 0, 0, fraImgEff.frameWidth, fraImgEff.frameHeight / num27 * (num26 + 1), 0, point18.x, point18.y, mGraphics.BOTTOM | mGraphics.HCENTER, mGraphics.isFalse);
						if (f < 3)
						{
			...
			case 55:
			{
				...
				for (int num17 = 0; num17 < VecEff.size(); num17++)
				{
					if (num17 < VecEff.size())
					{
						Line line2 = (Line)VecEff.elementAt(num17);
						int cl3 = 16777209;
						if (line2.idColor == 1)
						{
							cl3 = 16314560;
			...
			case 58:
			{
				...
				{
					Point point44 = (Point)VecEff.elementAt(num59);
			...
			case 77:
			{
				...
				{
					Point point42 = (Point)VecEff.elementAt(num57);
					if (f >= point42.f)
					{
						continue;
					}
					for (int num58 = 0; num58 < point42.vecEffPoint.size(); num58++)
					{
						Point point43 = (Point)point42.vecEffPoint.elementAt(num58);
						if (point43.dis == 1)
						{
			...
			case 62:
			{
				...
				{
					Point point38 = (Point)VecEff.elementAt(num53);
					if (point38.f > 0)
					{
			...
			case 63:
			{
				...
				{
					Point point35 = (Point)VecEff.elementAt(num49);
					if (point35.f > 0)
					{
			...
			case 73:
			{
				...
				{
					Point point28 = (Point)VecSubEff.elementAt(num38);
				...
				{
					Point point29 = (Point)VecEff.elementAt(num39);
					if (point29.f > 0)
					{
			...
			case 71:
			{
				...
				{
					Point point17 = (Point)VecEff.elementAt(num23);
					if (f <= fRemove)
					{
						int num24 = 0;
						num24 = ((f < 3) ? f : ((f <= fRemove - 3) ? CRes.random(2, 4) : (fRemove - f)));
						fraImgEff.drawFrameEffectSkill(num24, point17.x, point17.y, 0, mGraphics.BOTTOM | mGraphics.HCENTER, g);
						if (f < 6)
						{
			...
			case 72:
			{
				...
				{
					Point_Focus point_Focus2 = (Point_Focus)VecEff.elementAt(num14);
			...
			case 76:
			{
				...
				{
					Point point54 = (Point)VecEff.elementAt(num72);
			...
			case 85:
			{
				...
				for (int num62 = VecEff.size() - 1; num62 >= 0; num62--)
				{
					Line line4 = (Line)VecEff.elementAt(num62);
					if (line4 != null)
					{
						int num63 = 0;
						num63 = colorStar[0][line4.idColor];
						g.setColor(num63);
			...
			case 92:
				...
				if (typeEffect == 89 || typeEffect == 92)
				{
					...
					{
						Point point41 = (Point)VecEff.elementAt(num56);
			...
			case 93:
			{
				...
				{
					Point point36 = (Point)VecEff.elementAt(num50);
					if (f <= fRemove)
					{
						int num51 = 0;
						num51 = ((f < 3) ? f : ((f <= fRemove - 3) ? CRes.random(2, 4) : (fRemove - f)));
						fraImgEff.drawFrameEffectSkill(num51, point36.x, point36.y, 0, mGraphics.BOTTOM | mGraphics.HCENTER, g);
					}
				}
				break;
			}
			...
			case 95:
			{
				...
				if (f % 5 < 2 || f % 5 == 3)
				{
					for (int num29 = 1; num29 < VecEff.size(); num29++)
					{
						Point point19 = (Point)VecEff.elementAt(num29 - 1);
						Point point20 = (Point)VecEff.elementAt(num29);
					...
					for (int num30 = 1; num30 < VecSubEff.size(); num30++)
					{
						Point point21 = (Point)VecSubEff.elementAt(num30 - 1);
						Point point22 = (Point)VecSubEff.elementAt(num30);
			...
			case 96:
				...
				if (typeEffect == 96)
				{
					...
					{
						Point point16 = (Point)VecEff.elementAt(num22);
	...
	public override void update()
	{
		...
		try
		{
			...
			case 110:
				if (VecEff.size() > 0)
				{
					Point point49 = (Point)VecEff.elementAt(0);
					if (point49 != null)
					{
						x = point49.x;
						y = point49.y;
			...
			case 115:
			{
				for (int num40 = 0; num40 < VecEff.size(); num40++)
				{
					...
					if (point28.f == 0)
					{
						...
						{
							int tile = GameCanvas.loadmap.getTile(point28.x / 1000, point28.y / 1000);
							if (tile == -1 || tile == 1 || !MainEffect.isInScreen(point28.x / 1000, point28.y / 1000, fraImgEff.frameWidth, fraImgEff.frameHeight))
							{
								point28.f = 1;
							}
						}
			...
			case 113:
			{
				for (int num56 = 0; num56 < VecEff.size(); num56++)
				{
					...
					{
						point40.update();
						if (point40.f >= point40.fRe)
						{
							point40.dis = 1;
							point40.f = 0;
							if (!GameCanvas.lowGraphic && CRes.random(4) == 0)
							{
								GameScreen.addEffectEndKill((typeEffect != 20) ? 10 : 24, point40.x, point40.y);
							}
						}
					}
					else if (point40.dis == 1)
					{
						point40.f++;
						if (point40.f >= 2 && test == 0)
						{
							VecEff.removeElement(point40);
							num56--;
						}
					}
				}
			...
			case 27:
			{
				...
				else if (objKill != null)
				{
					...
					if (VecEff.size() == 0)
					{
						...
						removeEff();
						if (GameCanvas.loadmap.getTile(objKill.x, objKill.y) == 2)
						{
			...
			case 23:
			{
				for (int num62 = 0; num62 < VecEff.size(); num62++)
				{
					...
					point46.update();
					if (point46.f >= point46.fRe)
					{
						VecEff.removeElement(point46);
						num62--;
					}
				}
			...
			case 34:
			{
				for (int num67 = 0; num67 < VecEff.size(); num67++)
				{
					Point point48 = (Point)VecEff.elementAt(num67);
					point48.update();
					if (point48.f >= 3)
					{
					...
					else
					{
						...
						if (indexLan < vecObjBeKill.size())
						{
							...
							do
							{
								...
								mainObject4 = MainObject.get_Item_Object(object_Effect_Skill6.ID, object_Effect_Skill6.tem);
								if (mainObject4 != null)
								{
							...
							while (mainObject4 == null && indexLan < vecObjBeKill.size());
						}
						if (indexLan >= vecObjBeKill.size() && mainObject4 == null)
						{
							f = 56;
						}
					}
			...
			case 40:
			{
				...
				{
					((Point)VecSubEff.elementAt(num47)).update();
					if (f > 16)
					{
			...
			case 43:
			{
				...
				{
					Point point37 = (Point)VecEff.elementAt(num51);
					if (CRes.random(3) == 0)
					{
						if (point37.fRe == 1)
						{
			...
			case 49:
			{
				...
				{
					Point point50 = (Point)VecEff.elementAt(num69);
					point50.f++;
					if (point50.f >= 5)
					{
			...
			case 104:
			{
				for (int num59 = 0; num59 < VecEff.size(); num59++)
				{
					Point point43 = (Point)VecEff.elementAt(num59);
					if (f == 1)
					{
						LoadMap.timeVibrateScreen = 103;
						if (typeEffect == 75)
						{
							GameScreen.addEffectEndKill(15, point43.x, point43.y);
						}
						else
						{
							GameScreen.addEffectEndKill(9, point43.x, point43.y);
						}
						if (typeEffect == 64)
						{
							GameScreen.addEffectEndKill(15, point43.x, point43.y);
							GameScreen.addEffectEndKill(28, point43.x, point43.y - 2);
						}
						else if (typeEffect == 53 || typeEffect == 78 || typeEffect == 104)
						{
							GameScreen.addEffectEndKill(25, point43.x, point43.y - 2);
						}
					}
					point43.f++;
				}
			...
			case 77:
			{
				for (int num52 = 0; num52 < VecEff.size(); num52++)
				{
					Point point38 = (Point)VecEff.elementAt(num52);
					for (int num53 = 0; num53 < point38.vecEffPoint.size(); num53++)
					{
						((Point)point38.vecEffPoint.elementAt(num53)).x += point38.vx;
					}
					if (f == point38.f)
					{
						...
						GameScreen.addEffectEndKill(40, point38.x, point38.y + point38.vy * f / 1000 - 4 + 10);
						if (typeEffect == 61)
						{
							GameScreen.addEffectEndKill(27, point38.x + 3, point38.y + point38.vy * f / 1000 + 10);
							GameScreen.addEffectEndKill(15, point38.x, point38.y + point38.vy * f / 1000);
							GameScreen.addEffectEndKill(0, point38.x, point38.y + point38.vy * f / 1000);
						}
						else if (typeEffect == 77)
						{
							mSound.playSound(32, mSound.volumeSound);
							GameScreen.addEffectEndKill(30, point38.x + 3, point38.y + point38.vy * f / 1000 + 10);
							GameScreen.addEffectEndKill(14, point38.x, point38.y + point38.vy * f / 1000);
							GameScreen.addEffectEndKill(0, point38.x, point38.y + point38.vy * f / 1000);
						}
					}
					else if (f < point38.f)
					{
						point38.x += point38.vx;
						flag2 = false;
					}
				}
				if (flag2)
			...
			case 63:
			{
				for (int num48 = 0; num48 < VecEff.size(); num48++)
				{
					Point point36 = (Point)VecEff.elementAt(num48);
					point36.update();
					if (point36.f >= point36.fRe)
					{
						VecEff.removeElement(point36);
						num48--;
					}
				}
				if (f >= fRemove && VecEff.size() == 0)
			...
			case 76:
			{
				for (int num58 = 0; num58 < VecEff.size(); num58++)
				{
					...
					point42.x += point42.vx;
					point42.y += point42.vy;
					int tile2 = GameCanvas.loadmap.getTile(point42.x / 1000, point42.y / 1000);
					if (tile2 == -1 || tile2 == 1 || !MainEffect.isInScreen(point42.x / 1000, point42.y / 1000, fraImgEff.frameWidth, fraImgEff.frameHeight))
					{
			...
			case 88:
			{
				...
				{
					Point point47 = (Point)VecEff.elementAt(num66);
					point47.f++;
					if (point47.f / 2 > 3)
					{
			...
			case 65:
			{
				for (int num65 = 0; num65 < vecObjBeKill.size(); num65++)
				{
					...
					if (MainObject.get_Item_Object(object_Effect_Skill5.ID, object_Effect_Skill5.tem) != null && objKill != null)
					{
			...
			case 96:
			{
				...
				for (int num55 = 0; num55 < VecEff.size(); num55++)
				{
					Point point39 = (Point)VecEff.elementAt(num55);
					point39.f++;
					if (point39.f / 2 > 3)
					{
	...
	private void createLighting(int xFrom, int yFrom, int xTo, int yTo, bool isEnd)
	{
		...
		for (int i = 0; i < num4; i++)
		{
			...
			else
			{
				...
				if ((MainObject.getDistance(point2.x / 1000, point2.y / 1000, xTo, yTo) < 25 || i == num4 - 1) && isEnd)
				{
					point.x = xTo * 1000;
					point.y = yTo * 1000;
					VecEff.addElement(point);
	...
	private void create_2Kiem_GaiDoc()
	{
		...
		int num5 = 0;
		int num6 = 0;
		int num7 = CRes.angle(toX - x, toY - y);
		int distance = MainObject.getDistance(toX - x, toY - y);
		if (distance > 60)
		{
			num = x * 1000 + (distance - 50) * CRes.cos(num7);
			num2 = y * 1000 + (distance - 50) * CRes.sin(num7);
		}
		num3 = 18 * CRes.cos(num7);
		num4 = 18 * CRes.sin(num7);
		Point point = new Point();
		point.fRe = 0;
		point.x = num + num3;
		point.y = num2 + num4;
		...
		for (int i = 1; i < 6; i++)
		{
			...
			point.fRe = i / 2;
			Point point2 = (Point)VecEff.elementAt(i - 1);
			point.x = point2.x + num3 + ((i % 2 != 0) ? num5 : (-num5));
			if (num7 > 1575 && num7 <= 3375)
			{
				point.y = point2.y + num4 + ((i % 2 != 0) ? num6 : (-num6));
			}
			else
			{
				point.y = point2.y + num4 + ((i % 2 != 0) ? (-num6) : num6);
	...
	{
		if (type != 93 && type != 99 && type != 95 && type != 96 && type != 97 && type != 98 && type != 108 && type != 113 && type != 104 && type != 114)
		{
			return type == 115;
		}
		return true;
