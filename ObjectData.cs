...
public class ObjectData
{
	...
	public static MainImage getImagePartNPC(short id)
	{
		...
		if (mainImage == null)
		{
			...
			if (id >= 500)
			{
				url = "/resLocal/npc/icon/" + (id - 500) + ".png";
			}
	...
	public static MainImage getImagePotion(short id)
	{
		...
		if (mainImage == null)
		{
			...
			mImage mImage2 = mImage.createImage("/resLocal/potion/potionIcon_" + ((id + 1 < 10) ? ("0" + (id + 1)) : (id + 1 + string.Empty)) + ".png");
			if (mImage2 == null)
			{
	...
	public static MainImage getImageSkill(short id)
	{
		...
		if (mainImage == null)
		{
			...
			mImage mImage2 = mImage.createImage((id >= 10) ? ("/resLocal/skill/iconSkill_" + id + ".png") : ("/resLocal/skill/iconSkill_0" + id + ".png"));
			if (mImage2 == null)
			{
	...
	public static MainImage getImageIconClan(short id)
	{
		...
		if (mainImage == null)
		{
			...
			if (id >= 500)
			{
				url = "/resLocal/iconclan/shop/" + (id - 500) + ".png";
			}
			mImage mImage2 = mImage.createImage(url);
			if (mImage2 == null)
			{
