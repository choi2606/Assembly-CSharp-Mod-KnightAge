public class CreateChar : MainScreen
{
	...
	public override void update()
	{
		...
		{
			((Other_Players)VecDefaultChar.elementAt(indexChar)).Direction = 0;
		}
		...
		{
			Other_Players obj = (Other_Players)VecDefaultChar.elementAt(indexChar);
			obj.Action = 1;
			obj.f = 0;
		}
		else if (timeChangeClass > 80)
		{
			Other_Players obj2 = (Other_Players)VecDefaultChar.elementAt(indexChar);
			timeChangeClass = 1;
			obj2.Action = 0;
			obj2.f = 0;
			obj2.Direction = ++obj2.Direction % 4;
		}
		timeChangeClass++;
		tfNameChar.update();
		fFocus++;
