			...
			case 0:
				if (Next == 2)
				{
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						if (Main.isPC)
						{
							msgDialog.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, GameCanvas.hw - 45, PaintInfoGameScreen.yPointMove - PaintInfoGameScreen.wArrowMove - 5, 6, isCamera: false, 90);
						}
						else
						{
							msgDialog.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, PaintInfoGameScreen.xPointMove - 45, PaintInfoGameScreen.yPointMove - PaintInfoGameScreen.wArrowMove - 5, 2, isCamera: false, 90);
						}
			...
			case 1:
				if (Next == 0)
				{
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						if (Main.isPC)
						{
							msgDialog8.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, GameCanvas.hw - 40, PaintInfoGameScreen.yPointKill - 40, -1, isCamera: false, 80);
						}
						else
						{
							msgDialog8.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, PaintInfoGameScreen.xPointKill - 40, PaintInfoGameScreen.yPointKill - 40, 2, isCamera: false, 80);
						}
				...
				if (Next == 8)
				{
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						msgDialog9.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, PaintInfoGameScreen.mPosOther[0][0], PaintInfoGameScreen.mPosOther[0][1] + 22, 3, isCamera: false, 90);
			...
			case 3:
				...
				case 4:
					if (!GameCanvas.isVN_Eng && !IndoServer.isIndoSv)
					{
						...
						{
							if (((MainItem)Item.VecInvetoryPlayer.elementAt(i)).ItemCatagory == 3)
							{
								num = i + 1;
								break;
							}
			...
			case 5:
				...
				case 1:
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						msgDialog7.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, GameCanvas.w - 96, GameCanvas.minimap.maxY * MiniMap.wMini + 16, 5, isCamera: false, 90);
				...
				case 2:
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						msgDialog6.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, GameCanvas.w - 96, GameCanvas.minimap.maxY * MiniMap.wMini + 16, 6, isCamera: false, 90);
				...
				case 4:
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						msgDialog4.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, GameCanvas.w - GameCanvas.minimap.maxX * MiniMap.wMini - 96, 45, 4, isCamera: false, 90);
				...
				case 5:
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						msgDialog3.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, (!Main.isPC) ? (PaintInfoGameScreen.mPosOther[3][0] - 96 + 25) : (GameCanvas.hw - 45), PaintInfoGameScreen.mPosOther[3][1] - 10, (!Main.isPC) ? 1 : (-1), isCamera: false, 90);
				...
				case 6:
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						msgDialog5.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, PaintInfoGameScreen.mPosOther[2][0] - 96 + 25, PaintInfoGameScreen.mPosOther[2][1] - 10, 1, isCamera: false, 90);
				...
				case 7:
					...
					if (Next < T.mHelpPoint[Step].Length && T.mHelpPoint[Step][Next].Length > 0)
					{
						...
						msgDialog2.setDiaHelp(T.mHelpPoint[Step][Next], cmdNext, PaintInfoGameScreen.mPosOther[1][0], PaintInfoGameScreen.mPosOther[1][1] + 45, 3, isCamera: false, 90);
